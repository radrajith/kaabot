...
void motion_kaabot(float pulseWidthLeft, float pulseWidthRight)
{
    ...
    //float value2 = pulseWidthRight;
     //KAA_LOG_WARN(kaa_context_->logger, 0, value);
        //value = value + .1f;
